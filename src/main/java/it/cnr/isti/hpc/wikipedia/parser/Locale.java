...
public class Locale {
	...
	public Map<String, String> insertDisambiguation(){
		...
		m.put("ar" ,"Disambig|صفحة توضيح|توضيح");
		m.put("arc" ,"?|?.?.|Disambig");
		m.put("arz" ,"توضيح");
		m.put("as" ,"দ্ব্যর্থতা_নিরসন");
		m.put("ast" ,"Dixebra");
		m.put("av" ,"Неоднозначность");
		m.put("ay" ,"Desambiguación");
		m.put("az" ,"D?qiql?sdirm?");
		m.put("ba" ,"Disambiguation|Күп мәғәнәлелек|Неоднозначность|Disambig");
		m.put("bar" ,"Begriffsklärung|Begriffsklearung");
		m.put("bat_smg" ,"Daugiareikšmis|Disambig");
		m.put("bcl" ,"Clarip");
		m.put("be" ,"Неадназначнасць");
		m.put("be_x_old" ,"Disambig|Неадназначнасьць");
		m.put("bg" ,"Пояснение|Disambig");
		m.put("bjn" ,"Disambig");
		m.put("bm" ,"Homonymie");
		m.put("bn" ,"Disambiguation|দ্ব্যর্থতা_নিরসন|দ্ব্যর্থতা নিরসন|Disambig");
		m.put("bpy" ,"দ্ব্যর্থতা_নিরসন|সন্দই চুম");
		...
		m.put("ce" ,"Цхьа цӀе йолу урамаш|Disambiguation|Цхьа цӀе йолу меттигаш|Цхьа цӀе йолу аьчка некъа агӀонаш|Moviedis|Disambig|Дуккха маьӀнца|Цхьа цӀе йолу шагойтарш|Surname|Placedis|Metrodis|Roaddis|Неоднозначность|Цхьатера маьӀна доцуш|Доьзал цӀе");
		m.put("ceb" ,"Disambig|Giklaro");
		m.put("ch" ,"Disambig");
		m.put("ckb" ,"ڕوونکردنەوە");
		...
		m.put("cu" ,"Мъногосъмꙑслиѥ|Мъногосъмꙑ́сли|Disambi|Мъногосъмыслиѥ");
		m.put("cv" ,"Disambig");
		...
		m.put("fa" ,"ابهام‌زدایی-جغرافیا|رفع ابهام|ابهام‌زدایی|ابهام زدایی|ابهام‌زدائی");
		m.put("ff" ,"Homonymie");
		...
		m.put("gan" ,"消含糊|消除歧义|消歧义|消除歧義|Disambig|消歧義|消除含糊");
		m.put("gd" ,"Soilleireachadh");
		m.put("gl" ,"Disambig|Homónimos");
		m.put("glk" ,"ابهام‌زدایی");
		m.put("gn" ,"Disambig");
		m.put("gv" ,"Reddaghey");
		m.put("he" ,"פירושונים");
		m.put("hi" ,"Disambiguation|Disambig|बहुवि|बहुविकल्पी शब्द");
		m.put("hif" ,"Disambig");
		...
		m.put("hy" ,"Բազմիմաստ|Բազմանշանակություն|Բի|Բազմանշանակ|Disambig|Բազմիմաստություն|Երկիմաստ");
		...
		m.put("ie" ,"Disambig");
		m.put("ii" ,"消含糊|消除歧义|消歧义|消除歧義|Disambig|消歧義|消除含糊");
		m.put("ilo" ,"Disambig");
		m.put("io" ,"Homonimo");
		...
		m.put("ka" ,"მრავმნიშ|Disambig|მრავალმნიშვნელოვანი");
		...
		m.put("kn" ,"ದ್ವಂದ್ವ ನಿವಾರಣೆ");
		m.put("ko" ,"분류 동음이의|동음이의|Disambig|동음이의어|동명이인");
		m.put("krc" ,"Disambiguation|Кёб магъаналы|Disambig");
		m.put("ksh" ,"Disambig");
		m.put("ku" ,"Cudakirin|Disambig");
		m.put("kv" ,"Неоднозначность");
		m.put("kw" ,"Klerheans");
		m.put("la" ,"Discretiva");
		m.put("lad" ,"Desambiguación");
		m.put("lb" ,"Homonymie Familljennumm|Homonymie|Homonymie Persounen|Disambig|Homonymie Ofkierzungen");
		m.put("lbe" ,"Неоднозначность");
		...
		m.put("mdf" ,"Disambiguation|Фкялемса ошкужот|Moviedis|Disambig|Surname|Фкялемса фильпт|Placedis|Фкялемса кит|Фкялемса метро валгамвастт|Атянь лем|Metrodis|Roaddis|Аф фкя смузь|Лама смусть");
		m.put("mg" ,"Pejy mitovy anarana|Homonymie");
		m.put("mhr" ,"Неоднозначность|Шуку ончыктымаш-влак|Шуко ончыктымаш-влак");
		m.put("mi" ,"Disambig");
		m.put("mk" ,"ГеоПојас|Појаснување|Disambig|Geodis|ЧИ-Појаснување|Hndis");
		m.put("ml" ,"വിവക്ഷകൾ|Disambig|നാനാര്‍ത്ഥം|നാനാർത്ഥങ്ങൾ");
		m.put("mn" ,"Disambig|Салаа утгатай|Салаа");
		m.put("mo" ,"Dezambiguizare|Disambig");
		m.put("mr" ,"Disambiguation|नि:संदिग्धीकरण");
		m.put("mrj" ,"Disambig");
		m.put("ms" ,"Nyahkekaburan|Disambig");
		m.put("mt" ,"Dizambigwazzjoni|Dizambig");
		m.put("mwl" ,"Disambig");
		m.put("myv" ,"Смустень коряс явома");
		m.put("mzn" ,"ابهام‌زدایی");
		...
		m.put("os" ,"Неоднозначность|Disambig");
		m.put("pa" ,"Disambig");
		...
		m.put("rue" ,"Чеперушка");
		m.put("sa" ,"Disambig");
		m.put("sah" ,"Disambiguation|Элбэх суолталаах өйдөбүллэр|Неоднозначность|Disambig|Surname|Фамилия");
		...
		m.put("sq" ,"Kthjellim");
		m.put("sr" ,"Višeznacna odrednica (latinica)|Хомограф|Disambiguation|Вишезначна одредница|Вишезначност|ВЗО|Višeznacna odrednica molekulske formule-lat|Взо|Disambig|Višeznacna-lat|Вишезначна|Disambig-lat");
		...
		m.put("sw" ,"Maana");
		m.put("szl" ,"Disambig");
		m.put("ta" ,"பக்கவழி நெறிப்படுத்தல்");
		m.put("te" ,"వివరమైన అయోమయ నివృత్తి|అయోమయ నివృత్తి");
		m.put("tg" ,"Ибҳомзудоӣ|Disambig");
		m.put("th" ,"แก้ความกำกวม|คำกำกวม|Disambig|แก้กำกวม");
		...
		m.put("tt" ,"Күп мәгънәләр|Күп мәгънәле");
		m.put("ty" ,"Homonymie");
		m.put("udm" ,"Disambiguation|Неоднозначность|Disambig|Многозначность");
		m.put("uk" ,"Неоднозначність|Ще є імена|Disambig|Багатозначність|DisambigN|Список однофамільців|DisambigG");
		m.put("ur" ,"Disambig");
		m.put("uz" ,"Disambig");
		...
		m.put("war" ,"Pansayod");
		m.put("wo" ,"Homonymie");
		m.put("wuu" ,"消歧義|消除歧义|消除含糊|Disambig|消除歧義|消歧义|消含糊");
		m.put("xal" ,"Медг-үлг");
		m.put("xmf" ,"მრავალმნიშვნელოვანი");
		m.put("yi" ,"באדייטן");
		m.put("yo" ,"Disambig|Ì?ojútùú");
		m.put("za" ,"消含糊|消除歧义|消歧义|消除歧義|Disambig|消歧義|消除含糊");
		m.put("zea" ,"Doorverwijspagina");
		m.put("zh" ,"Disambiguation|消除歧义|Letter disambig|消岐義|消岐義頁|Disambig|消除歧義|消歧义|消歧義頁|Chemdab|Disamb|分歧页|消歧义页|消歧義|MolFormDisambig|分歧|Dab|消除含糊|Isomerdab|分歧義|消含糊|Deprecated");
